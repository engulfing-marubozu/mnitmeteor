...
export const lostFoundEmpty = {
  ...
  lostItems: {
    ...
    text: "This is the page for all the lost items in the institute.",
  },
  ...
  myItems: {
    ...
    text: "The items that you have lost or found appear here.",
  },
};
export const profileEmpty = {
  ...
  myOrders: {
    svg: "https://res.cloudinary.com/mnitmarket/image/upload/v1650803917/Bookmarks-bro_kqa20m.svg",
    text: "The items you are interested in will appear here. ",
  },
};
